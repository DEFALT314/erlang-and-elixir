...
% dodaj do modułu pollution funkcje get_horuly_mean,
% która zwraca średnią wartość parametru zadanego typu o określonej godzinie każdego dnia dla określonej stascji
