...
add_station_test() ->
  ...
  R = pollution_server:add_station("Stacja 1", {1,1}),
  ?assertNotMatch({error, _}, R),
...
add_value_fail_test() ->
  ...
  _M1 = pollution_server:add_value("Stacja 1", Time, "PM10", 46.3),
...
remove_value_test() ->
  ...
  Time = calendar:local_time(),
  _M1 = pollution_server:add_value("Stacja 1", Time, "PM10", 46.3),
  _M2 = pollution_server:add_value("Stacja 1", Time, "PM1", 46.3),
  pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,9}}, "PM10", 46.3),
  M3 = pollution_server:get_state(),
  pollution_server:remove_value("Stacja 1", Time, "PM10"),
  M4 = pollution_server:get_state(),
...
remove_value_and_add_back_test() ->
  pollution_server:start(),
  _M = pollution_server:add_station("Stacja 1", {1,1}),
  Time = calendar:local_time(),
  _M1 = pollution_server:add_value("Stacja 1", Time, "PM10", 46.3),
  _M2 = pollution_server:add_value("Stacja 1", Time, "PM1", 46.3),
  pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,9}}, "PM10", 46.3),
...
get_daily_mean_test() ->
  ...
  ?assertNotMatch(15.0, pollution_server:get_daily_mean("PM10",{2023,3,27})),
  pollution_server:stop().
...
get_station_min_test() ->
  ...
  ?assertEqual(5, pollution_server:get_station_min("Stacja 1", "PM10")),
  pollution_server:stop().
